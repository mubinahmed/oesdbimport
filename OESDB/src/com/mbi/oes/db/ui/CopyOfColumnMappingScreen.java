...
public class CopyOfColumnMappingScreen extends GenericDataImportScreen {
	...
	private Logger logger_ = Logger.getLogger(CopyOfColumnMappingScreen.class);
	 ...
	 * @param style
	 */
	public CopyOfColumnMappingScreen(Composite parent, int style) {
		super(parent, style);
		initComponents();
	}
